...
import com.gittors.apollo.extend.event.ApolloEventBusPublisher;
...
public class ApolloExtendEventConfiguration {
    ...
    @Bean(ApolloEventBusPublisher.BEAN_NAME)
    ...
    public EventPublisher eventBusPublisher(ObjectProvider<EventControllerFactory> controllerFactory) {
        return new ApolloEventBusPublisher(controllerFactory.getIfAvailable());
    }
